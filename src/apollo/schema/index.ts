...
const typeDefs = mergeTypeDefs([
  postType, userType, categoryType, noticeType, suggestionType, bookmarkType,
]);
const resolvers = mergeResolvers([
  postResolver, userResolver, categoryResolver, noticeResolver, suggestionResolver, bookmarkResolver,
]);
